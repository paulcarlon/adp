...
<div className="" style={{   
      ...
      <iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1106226691&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe><div style={{ fontSize: '10px', color: '#cccccc', lineBreak: 'anywhere', wordBreak: 'normal', overflow: 'hidden', whiteSpace: 'nowrap', textOverflow: 'ellipsis',  fontFamily: 'Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif', fontWeight: '100'}}><a href="https://soundcloud.com/aubreydigital" title="aubrey digital" target="_blank" style={{ color: '#cccccc', textDecoration: 'none'}}>aubrey digital</a> · <a href="https://soundcloud.com/aubreydigital/it-dont-really-matter" title="It Don&#x27;t Really Matter" target="_blank" style={{ color: '#cccccc', textDecoration: 'none'}}>It Don&#x27;t Really Matter</a></div>
      <iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1106407039&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe><div style={{fontSize: '10px', color: '#cccccc', lineBreak: 'anywhere', wordBreak: 'normal', overflow: 'hidden', whiteSpace: 'nowrap', textOverflow: 'ellipsis',  fontFamily: 'Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif', fontWeight: 100}}><a href="https://soundcloud.com/aubreydigital" title="aubrey digital" target="_blank" style={{color: '#cccccc', textDecoration: 'none'}}>aubrey digital</a> · <a href="https://soundcloud.com/aubreydigital/refresh" title="Refresh" target="_blank" style={{color: '#cccccc',  textDecoration: 'none'}}>Refresh</a></div>
    </div></div>
